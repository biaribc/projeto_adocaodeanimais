...
<body>
    ...
    <div id="catalogo" class="container">
        ...
        <div id="container_catalogo" class="d-flex">
            <?php 
                $item_catalogo = $conexao->prepare("SELECT * FROM animal WHERE especie_animal LIKE 'cachorro' ORDER BY nome_animal");
                                    ...
                                    <div class="info_modal d-flex">
                                        ...
                                        <div class="w-50 p-2">
                                            <p>
                                                ...
                                                <a href="perfil_organizacao.php?id_organizacao=<?php echo($organizacao['id_organizacao']); ?>">
                                                    <?php echo ($organizacao['nome_organizacao']); ?>
                                                </a>
                                            </p>
