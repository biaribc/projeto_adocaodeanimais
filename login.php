...
<body class="">
    <div id="img_login" class="d-flex">
        ...
        <div class="rounded mx-auto" id="container_login">
            <form class="mx-auto p-2 text-center" method="POST" action="logar.php">
                <ul class="ml-auto mr-auto">
                    ...
                    <li><input type="email" class="form-control" name="email" id="" placeholder="E-mail"></li>
                    <li> <input type="password" class="form-control" name="senha" id="" placeholder="Senha"></li>
                    <li><input type="submit" class="btn" value="ACESSAR"></li>
                    <p class="text-center text-white"> Ainda não é cadastrado? <a href="cadastro_usuario.php">Cadastre-se!</a></p>
    ...
    <?php if (isset($_SESSION['erro_login'])) { ?>
                <div class=" w-100 text-center aviso">
                    <p class="bg-danger text-white">Usuário ou Senha Inválidos!</p>
                </div><?php
