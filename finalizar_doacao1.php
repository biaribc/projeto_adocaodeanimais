...
if(isset($_GET['id_candidatura'])){
    ...
    $usuario = $candidatura['id_usuario'];
...
<body>
    <?php include "menu.php"?>
        ...
        <div class="container rounded p-3 d-flex text-justify" height="80" id="container_doacao">
            ...
            <form action="" class="d-block w-75 mx-auto text-capitalize">
            <h3 class="laranja coiny text-center">Formulário de Doação</h3>
                ...
                <button class="bg_laranja text-white w-50 rounded"><a href="finalizar_doacao2.php?id_candidatura=<?php echo ($id_candidatura);?>">CONTINUAR ADOÇÃO</a>  </button></p>
            </form>
        </div>
    </div>
</body>
